...
using hls::sim::Byte;
extern "C" void simple_add(Byte<1>*, Byte<1>*, Byte<2>*);
extern "C" void apatb_simple_add_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
__xlx_c__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_c)[i]);
  ...
  // DUT call
  simple_add(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data());
