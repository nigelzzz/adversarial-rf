set moduleName u_branch_Pipeline_VITIS_LOOP_117_6
set isTopModule 0
...
set C_modelName {u_branch_Pipeline_VITIS_LOOP_117_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln126 int 12 regular  }
	{ y_tanh int 1 regular {array 4096 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln126", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln126 sc_in sc_lv 12 signal 0 } 
	{ y_tanh_address0 sc_out sc_lv 12 signal 1 } 
	{ y_tanh_ce0 sc_out sc_logic 1 signal 1 } 
	{ y_tanh_we0 sc_out sc_logic 1 signal 1 } 
	{ y_tanh_d0 sc_out sc_lv 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln126", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "zext_ln126", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "u_branch_Pipeline_VITIS_LOOP_117_6",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	u_branch_Pipeline_VITIS_LOOP_117_6 {
...
set Spec2ImplPortList { 
	zext_ln126 { ap_none {  { zext_ln126 in_data 0 12 } } }
